		...
		<>
			...
			<main className="max-w-[980px] mx-auto px-4 pt-12 pb-15">
				<div className="max-w-[420px] mx-auto">
					...
					<div className="bg-card border border-line rounded-2xl p-[18px] mb-3.5">
						<div className="font-bold mb-3">Continue with Strava</div>
						<a
							href="/api/auth/strava"
							className="block text-center no-underline px-5 py-2.5 rounded-full border border-[rgba(252,76,2,0.4)] text-text bg-[rgba(252,76,2,0.1)] hover:bg-[rgba(252,76,2,0.18)] cursor-pointer"
						>
							Connect Strava
						</a>
					</div>
